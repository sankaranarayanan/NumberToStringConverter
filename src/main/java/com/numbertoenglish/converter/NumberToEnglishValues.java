...
import static com.numbertoenglish.converter.NumberBuilder.baseNumbersBuilder;

public class NumberToEnglishValues implements BaseValues {
	...
	public List<NumberScale> numberScales() {
